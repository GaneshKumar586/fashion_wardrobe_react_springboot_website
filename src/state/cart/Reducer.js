...
const stateZero = {
    cart:null,
    loading:false, eroor:null, cartItems:[],
}

export const cartReducer = (state = stateZero,action)=>{
    switch( action.type ){
        case ADD_ITEM_TO_CART_REQUEST:
            return {...state, loading: true, error:null};
        case ADD_ITEM_TO_CART_SUCCESS:
            return {...state, cartItems: [...state.cartItems, action.ayload.cartItems], loading: false,};
