...
const singleFilter=[
  ...
  },
  {
    ...
    name:"Price",
    options:[
        {value:"160-400", label:"₹ 160 to ₹ 400"},
        {value:"401-900", label:"₹ 401 to ₹ 900"},
        {value:"901-1600", label:"₹ 901 to ₹ 1600"},
        {value:"1601-2500", label:"₹ 1601 to ₹ 2500"},
  ...
  return (
    <div className="bg-white">
      <div>
        ...
        <main className="mx-auto mr-2 max-w-8xl px-4 sm:px-6 lg:px-8">
                    ...
                    {({ open }) => (
                      <>
                        ...
                        <h3 className="-my-3 flow-root">
                          ...
                          <DisclosureButton className="flex w-full items-center justify-between bg-white py-3 text-sm text-gray-400 hover:text-gray-500">
                            {/* <span className="font-medium text-gray-900">{section.name}</span> */}
                            <FormLabel sx={{color:"black"}}id="demo-controlled-radio-buttons-group" className="font-medium text-gray-900">{section.name}</FormLabel>
                            <span className="ml-6 flex items-center">
                              {open ? (
                                <MinusIcon className="h-5 w-5" aria-hidden="true" />
                              ) : (
                        ...
                        <DisclosurePanel className="pt-6">
                          ...
                          <RadioGroup
                            ...
                            {section.options.map((option, optionIdx) => (
                                ...
                                <>
                                    <FormControlLabel onChange={(e)=>handleSingleFilter(e,section.id)} className='text-black ' value={option.value} control={<Radio />} label={option.label} />
